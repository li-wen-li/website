...
tags:
  - probability
  - life
thumbnail: images/cast_away.jpeg
...
So, to actually reach the island where Chuck Noland was stranded, 400 miles away from that search circle's center, the search party would need to search for $\pi$ * $400^{2}$ $miles^{2}$ =  502400 $mile^{2}$
